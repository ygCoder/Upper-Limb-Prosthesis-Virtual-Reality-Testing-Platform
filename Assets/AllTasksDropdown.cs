...
public class AllTasksDropdown : MonoBehaviour
{
    Animator animator;
    ...
    void Start()
    {
        ...
        taskList.Add(new Dropdown.OptionData("None"));
        ...
        foreach (ChildAnimatorStateMachine state in ac.layers[0].stateMachine.stateMachines)
        {
            taskList.Add(new Dropdown.OptionData(state.stateMachine.name));            
        }
